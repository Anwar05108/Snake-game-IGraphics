...
void iDraw()
{
    ...
    if(gamestate==0)
    {
        iShowBMP(0,0,"wallp.bmp");
        iText(tx, ty, "PLAY", GLUT_BITMAP_HELVETICA_18);
        iText(tx, ty-50, "HELP", GLUT_BITMAP_HELVETICA_18);
        iText(tx,ty-100,"HIGH SCORE",GLUT_BITMAP_HELVETICA_18);
    ...
    //iClear();
      ...
      if(gamestate==1)
    {
        iText(10, 276, "LIVES LEFT:", GLUT_BITMAP_HELVETICA_18);
